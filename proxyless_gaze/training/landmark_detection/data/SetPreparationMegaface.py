...
def handle_single(attr):
    ...
    if Img.empty:
        return ""
    img_name = Img.path
    Img.load_data(is_train, 1, "Mirror98.txt")
    if Img.empty:
        return ""
...
if __name__ == '__main__':
    root_dir = "/dev/shm/megaface_ready"
    landmarkDirs = ['/data/junyanli/datasets/megaface/megaface_face_info.txt']
    imageDirs = ['/data/junyanli/datasets/megaface/data/MegaFaceDistractor/FlickrFinal2']
    outDirs = ['train_data']
